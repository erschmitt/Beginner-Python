...
print("Congratulations! You finally managed to get a job interview at %s. Follow these a steps and you'll be %s for sure!" % (company_name, adj1))
print("1  Make sure you dress appropriately. You should probably wear something like %s" % (clothing))
...
print("3  Smile, be %s and remember a firm a shake is always a plus!" % (adj6))
